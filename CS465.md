---
layout: default
title: "Travlr Getaways – Software Design and Engineering (CS 465)"
---

[![Generic badge](https://img.shields.io/badge/development_tool-Visual_Studio_Code-orange.svg)](https://code.visualstudio.com/)
[![Generic badge](https://img.shields.io/badge/language-JavaScript_|_TypeScript-blue.svg)](https://developer.mozilla.org/docs/Web/JavaScript)
[![Generic badge](https://img.shields.io/badge/stack-MEAN_(MongoDB,_Express,_Angular,_Node)-yellow.svg)](https://www.mongodb.com/languages/mean-stack-tutorial)
[![Generic badge](https://img.shields.io/badge/category-Software_Design_and_Engineering-lightgrey.svg)](#)
...
<div style="text-align: center;">
    <p>
        <img src="assets/img/cs465-original-home.png" width="400px" />&nbsp;&nbsp;&nbsp;
        <img src="assets/img/cs465-original-login.png" width="400px"/>
    </p>
...
<div style="text-align: center;">
    <p>
        <img src="assets/img/cs465-trip-list-logged-out.png" width="400px" />&nbsp;&nbsp;&nbsp;
        <img src="assets/img/cs465-trip-list-logged-in.png" width="400px" />
    </p>
...
<div style="text-align: center;">
    <p>
        <img src="assets/img/cs465-login.png" width="400px" />&nbsp;&nbsp;&nbsp;
        <img src="assets/img/cs465-add-trip-form.png" width="400px" />
    </p>
...
<div style="text-align: center;">
    <p>
        <img src="assets/img/cs465-mongo-connected.png" width="400px" />
    </p>
...
You can explore the enhanced artifact and supporting files in my GitHub repository: Artifact enhancement files repository at [CS465 Full Stack Development I](enhanced_artifacts/CS465/CS465-Travlr_Getaways-Enhanced.zip)
