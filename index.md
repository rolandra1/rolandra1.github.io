...
I began my Computer Science journey at Southern New Hampshire University in 2023 by going straight into the bachelor’s program with a concentration in Information Security. I did not want to wait or “try it out” slowly. I knew I wanted to work in technology and security, and my eagerness to learn, my long term goals, and my inspiration to protect people and data pushed me to commit fully from the start.  

At the same time, I continued serving as a United States Navy Hospital Corpsman and Radiation Health Technician. In that role, I am trusted with sensitive medical and radiation health information and the readiness of sailors. Working in that environment shaped my mindset. Accuracy, accountability, and confidentiality are not just ideas for me. They are daily expectations. Studying computer science with a focus on information security felt like a natural extension of that responsibility.

The Computer Science program gave me a way to turn that mindset into technical skills. I learned how to think through problems step by step, design solutions, and then implement them with clean, organized code. Courses in programming, networking, security, and databases helped me understand how data moves, where it can be exposed, and how to protect it. My concentration in information security helped me connect topics such as authentication, encryption, and secure design with the real-world risks I already knew from handling health and radiation records.

As I progressed through the program, I gained hands-on experience with Java, Python, JavaScript, SQL, and full-stack development. I created mobile apps, web applications, and an artificial intelligence project, then returned to those artifacts in my capstone to enhance them with stronger structure and security. This cycle of building, reviewing, and improving taught me to treat every project like a living system that can always be refined.

Balancing full-time Navy duties with a demanding Computer Science degree also forced me to grow in discipline and time management. There were many nights when I moved from shipboard responsibilities and radiation health tasks straight into coding, debugging, or writing. That experience made me better at planning my work, communicating clearly with professors and teammates, and staying focused even when I felt tired or overwhelmed.

Today, my self-assessment reflects both sides of who I am. I am a Hospital Corpsman who understands the impact of protecting real people and their data. I am also a computer science professional with a concentration in Information Security who can design, build, and secure software systems. This ePortfolio brings those two paths together and shows how my eagerness to learn, my aspirations, and my inspiration to serve others shaped my growth in the program and prepared me for my future in secure software development.
...
<div style="text-align: center;">
    <a href="https://rolandra1.github.io/CS465" title="Artifact: Software Design and Engineering">
...
<div style="text-align: center;">
    <a href="https://rolandra1.github.io/CS370" title="Artifact: Algorithms and Data Structures">
        <img src="https://img.shields.io/badge/Artifact-Algorithms_and_Data_Structures-orange.svg?style=for-the-badge&logo=thealgorithms" alt="Artifact: Algorithms and Data Structures" />
    </a>
</div>
...
<div style="text-align: center;">
    <a href="https://rolandra1.github.io/CS360" title="Artifact: Databases">
